const descriptions = [
    {
        ...
        <ul>
            ...
            <li><i class="fa-solid fa-circle-check"></i> No usar ingredientes irritantes.</li>
        </ul>`,
        descripcionesFinales: {
            descripcionInicial1: `<p>Calificación general</p>
            <div class="productDescriptionIcon">
                <div class="productDescriptionIconStars"><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i></div>
                <div class="productDescriptionIconStars"><i class="fa-solid fa-star"></i>   <i class="fa-solid fa-star"></i>   <i class="fa-solid fa-star"></i>   <i class="fa-solid fa-star"></i>   <i class="fa-solid fa-star"></i></div>
            </div>
