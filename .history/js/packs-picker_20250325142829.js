    ...
    function toggleContainer(labelId, containerId) {
        ...
        label.addEventListener("click", function() {
          if (container.classList.contains("active")) {
            // Cerrar: fija la altura actual, fuerza reflow y luego anima a 0
            container.style.height = container.scrollHeight + "px";
            container.offsetHeight; // Forzar reflow
            container.style.height = "0px";
            container.classList.remove("active");
          } else {
            // Abrir: primero medimos la altura "auto"
            container.style.height = "auto";
            const autoHeight = container.scrollHeight;
            // Reiniciamos la altura para poder animar
            container.style.height = "0px";
            container.offsetHeight; // Forzar reflow
        ...
        // Al terminar la transición, si está abierto, dejamos height en "auto" para que se adapte a cambios de contenido.
      ...
      // Aplica la función a cada par de label y contenedor
      toggleContainer("sunscreenLabel", "RPC1");
      toggleContainer("boosterLabel", "RPC2");
      toggleContainer("tecnicaLabel", "RPC3");
