document.addEventListener("DOMContentLoaded", function () {
    ...
    function enviarMensaje() {
        ...
        const codigoPedido = Math.floor(Math.random() * (9999999 - 1000000 + 1)) + 1000000;
    
        const mensaje = `Quiero confirmar el pedido de una ${rutina} con los siguientes productos:\n${productos.join("\n")}\nPor un valor de ${total} con envío ${envio}.\nEl código del pedido es ${codigoPedido}`;
