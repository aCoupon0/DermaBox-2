const descriptions = [
    {
        ...
        descripcionesFinales: {
            ...
            <div class="productDescriptionIcon">
                <div class="productDescriptionIcon1"><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i></div>
