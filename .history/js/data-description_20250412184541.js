const descriptions = [
    {
        ...
        descripcionesFinales: {
            ...
            <div class="productDescriptionIcon">
                <div class="productDescriptionIconStars"><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>    <i class="fa-solid fa-star" style="color: #aaaaaa;"></i>   <i class="fa-solid fa-star" style="color: #aaaaaa;"></i></div>
