document.addEventListener("DOMContentLoaded", function () {
    ...
    function asignarProductos() {
        ...
        if (!contenedor_base || !contenedor_premium || !contenedor_premium_plus) {
            ...
            contenedor_base.textContent = `+${baseRoutinePrice.toLocaleString("es-ES")}`;
            contenedor_premium.textContent = `+${premiumRoutinePrice.toLocaleString("es-ES")}`;
            contenedor_premium_plus.textContent = `+${premiumPlusRoutinePrice.toLocaleString("es-ES")}`;
        }
    }
    ...
    <div class="productDescription" id="productDescription">
        ${descripciones.descripcionInicial1.join('')}
    </div>`;
