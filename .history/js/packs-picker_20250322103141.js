document.addEventListener("DOMContentLoaded", function () {
    ...
    function renderizarDescripciones() {
        ...
        document.getElementById("boosterImg").innerHTML = `<img src="../assets/products/${rutinaPremiumPlus[rutinaBase.length - 2].foto}.webp" alt="${rutinaPremiumPlus[rutinaPremiumPlus.length - 2].nombre}">`;
