document.addEventListener("DOMContentLoaded", function () {
    ...
    function toggleButton(buttonId, priceId, priceBase, extraCost, isIncludedVariable, imgId) {
    ...
    document.getElementById("addBase").addEventListener("click", () => {
        toggleButton("addBase", "basePrice", 80000, 30000, "isSunscreenBaseIncluded", "sunscreenImg1");
    });
    
    document.getElementById("addPremium").addEventListener("click", () => {
        toggleButton("addPremium", "premiumPrice", 150000, 90000, "isSunscreenPremiumIncluded", "sunscreenImg2");
    });
    
    document.getElementById("addPremiumPlus").addEventListener("click", () => {
        toggleButton("addPremiumPlus", "premiumPlusPrice", 250000, 90000, "isSunscreenPremiumPlusIncluded", "sunscreenImg3");
    });
