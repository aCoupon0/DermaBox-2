document.addEventListener("DOMContentLoaded", function () {
    ...
    const overlayProductList = document.querySelector(".routineDescriptionOverlayTxt");
    const content = document.querySelector(".routineDescriptionContent");

    if (overlayProductList && content) {
        overlayProductList.addEventListener("click", function () {
        ...
        overlayProductList.addEventListener("touchstart", function () {
