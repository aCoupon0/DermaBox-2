document.addEventListener("DOMContentLoaded", function () {
    ...
    <div class="productDescription" id="productDescription">
        // Aqui debemos crear una estructura como la presente en data-description, pero usando las propiedad ventaja y ventajaAdicional, simplemente dile que genere una funcion que reciba dos variables, siendo LB.ventajas y LP.ventajas + LP.ventajaAdicional en este caso.
    </div>`;
