document.addEventListener("DOMContentLoaded", function () {
    ...
    const sunscreenLabel = document.getElementById("sunscreenLabel");
    const boosterLabel = document.getElementById("boosterLabel");
    const rpc1 = document.getElementById("RPC1");
    const rpc2 = document.getElementById("RPC2");

    // Al hacer clic en sunscreenLabel
    sunscreenLabel.addEventListener("click", function() {
        rpc1.classList.add("active");
    });

    // Al hacer clic en boosterLabel
    boosterLabel.addEventListener("click", function() {
        rpc2.classList.add("active");
    });
