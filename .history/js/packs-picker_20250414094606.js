document.addEventListener("DOMContentLoaded", function () {
    ...
    <div class="productDescription" id="productDescription">
        ${descripciones.descripcionInicial1}
    </div>`;
    ...
    <div class="productDescription" id="productDescription">
        ${descripciones.descripcionInicial2}
    </div>`;
    ...
    <div class="productDescription" id="productDescription">
        ${descripciones.descripcionInicial3}
    </div>`;
    ...
    <div class="productDescription" id="productDescription">
    ${descripciones.descripcionInicial4}
    </div>`;
    ...
    document.getElementById("addBase").addEventListener("click", () => {
        toggleButton("addBase", "basePrice", baseRoutinePrice, "baseNames", rutinaBase);
    });

    document.getElementById("addPremium").addEventListener("click", () => {
        toggleButton("addPremium", "premiumPrice", premiumRoutinePrice, "premiumNames", rutinaPremiumPlus);
    });

    document.getElementById("addPremiumPlus").addEventListener("click", () => {
        toggleButton("addPremiumPlus", "premiumPlusPrice", premiumPlusRoutinePrice, "premiumPlusNames", rutinaPremiumPlus);
    });
