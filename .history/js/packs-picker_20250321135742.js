document.addEventListener("DOMContentLoaded", function () {
    ...
    function openModal(rutina, precioBase, precioSunscreen, envio) {
        let isSunscreenIncluded;
    
        if (rutina === rutinaBase) {
            isSunscreenIncluded = isSunscreenBaseIncluded;
        } else if (rutina === rutinaPremium) {
            isSunscreenIncluded = isSunscreenPremiumIncluded;
        } else if (rutina === rutinaPremiumPlus) {
            isSunscreenIncluded = isSunscreenPremiumPlusIncluded;
        }
    
        console.log("isSunscreenIncluded:", isSunscreenIncluded); // Verificamos el valor al abrir el modal
    ...
    openButtonBase.addEventListener("click", () => {
        openModal(rutinaBase, 80000, 30000, isSunscreenBaseIncluded ? "GRATIS" : "$6.000 COP");
    });
    
    openButtonPremium.addEventListener("click", () => {
        openModal(rutinaPremium, 150000, 90000, "GRATIS");
    });
    
    openButtonPremiumPlus.addEventListener("click", () => {
        openModal(rutinaPremiumPlus, 250000, 90000, "GRATIS");
    });
