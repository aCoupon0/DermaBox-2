document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector('.modalProductButton').addEventListener('click', e => {
        // closest busca hacia arriba en el DOM hasta encontrar un .productDelete
        const btn = e.target.closest('.productDelete');
        if (!btn) return;      // si no clicaste sobre uno, salimos
        alert(btn.id);
      });
