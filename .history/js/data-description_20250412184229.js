const descriptions = [
    {
        ...
        descripcionesFinales: {
            ...
            <div class="productDescriptionIcon">
                ...
                <div class="productDescriptionIcon2"><i class="fa-solid fa-star"></i>   <i class="fa-solid fa-star"></i>  <i class="fa-solid fa-star"></i>  <i class="fa-solid fa-star"></i>  <i class="fa-solid fa-star"></i></div>
            </div>
