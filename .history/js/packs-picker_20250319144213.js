document.addEventListener("DOMContentLoaded", function () {
    ...
    function toggleButton(buttonId, priceId, priceBase, extraCost, isIncludedVariable) {
    ...
    document.getElementById("addBase").addEventListener("click", () => {
        toggleButton("addBase", "basePrice", 80000, 30000, "isSunscreenBaseIncluded");
    });
    
    document.getElementById("addPremium").addEventListener("click", () => {
        toggleButton("addPremium", "premiumPrice", 150000, 90000, "isSunscreenPremiumIncluded");
    });
    
    document.getElementById("addPremiumPlus").addEventListener("click", () => {
        toggleButton("addPremiumPlus", "premiumPlusPrice", 250000, 90000, "isSunscreenPremiumPlusIncluded");
    });
