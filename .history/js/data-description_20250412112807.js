const descriptions = [
    {
        ...
        descripcionesFinales: {
            ...
            descripcionInicial2: ['<p><i class="fa-solid fa-check"></i>Hidratan sin sobrecargar y taponar los poros.</b></p>', ' <p><i class="fa-solid fa-check"></i>ContieneN activos que <b>calman y reparan</b> la piel durante la noche</p>'],
