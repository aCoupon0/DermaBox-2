    ...
    function toggleContainer(labelId, containerId) {
        ...
        label.addEventListener("click", function() {
          ...
          if (container.classList.contains("active")) {
            // Fijamos la altura actual y forzamos un reflow
            container.style.height = container.scrollHeight + "px";
            container.offsetHeight; // Forzar reflow
            // Iniciamos la transición a 0
            container.style.height = "0px";
            container.classList.remove("active");
            label.classList.remove("active");
          } else {
            // Para abrir: primero determinamos la altura natural ("auto")
            ...
            // Animamos hasta la altura calculada
      ...
      // Aplica la función a cada par label / contenedor
