document.addEventListener("DOMContentLoaded", function () {
    ...
    const descripciones = {
        ...
        descripionInicial1: ["Un limpiador hidratante", "Ideal para pieles sensibles, sin alcohol ni perfumes que puedan irritar la piel."],
        descripionInicial2: ["Un hidratante con vitamina C", "Con antioxidantes que tratan las manchas y recuperan la barrera protector de la piel."],
        descripionInicial3: ["Un bloqueador", "Con ingredientes hidratantes, y un color natural y suave para disimular manchas e imperfecciones."],
        descripionInicial4: ["Un potenciador", "Un serúm con extra hidratación y vitamina B5 + colágeno, para sellar la rutina."]
    }
